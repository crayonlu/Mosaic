...
export const MemoCard = memo<MemoCardProps>(({ memo, mode, selected, onSelect, onClick, onUnarchive }) => {
  ...
  return (
    <div
      className={cn(
        ...
        mode === 'view' && !isArchived && "hover:shadow-md hover:border-primary/50 cursor-pointer",
